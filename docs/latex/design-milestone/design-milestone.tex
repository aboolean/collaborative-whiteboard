...
The board selector in the left pane includes a list of all current whiteboards. Each line will represent a different board, which will be numbered sequentially and named by the user. Clicking on a board in the list will download the board from the server, overwriting the local copy if one exists, and display the board in the canvas window. 

%make change: prompted for board name upon creation (permananet)
